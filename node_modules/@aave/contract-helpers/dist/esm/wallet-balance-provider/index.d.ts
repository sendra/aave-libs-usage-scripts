...
import { BalanceOfResponse, BatchBalanceOfResponse, UserWalletBalancesResponse } from './types/WalletBalanceProviderTypes';
...
export declare class WalletBalanceProvider {
     ...
     */
    batchBalanceOf(users: string[], tokens: string[]): Promise<BatchBalanceOfResponse>;
    /**
     ...
     */
    getUserWalletBalancesForLendingPoolProvider(user: string, lendingPoolAddressProvider: string): Promise<UserWalletBalancesResponse>;
}
