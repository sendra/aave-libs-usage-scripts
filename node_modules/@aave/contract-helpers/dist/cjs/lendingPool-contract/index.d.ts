...
import { EthereumTransactionTypeExtended, LendingPoolMarketConfig } from '../commons/types';
...
import { LPBorrowParamsType, LPDepositParamsType, LPLiquidationCall, LPRepayParamsType, LPRepayWithCollateral, LPSetUsageAsCollateral, LPSwapBorrowRateMode, LPSwapCollateral, LPWithdrawParamsType, LPFlashLiquidation } from './lendingPoolTypes';
...
export declare class LendingPool extends BaseService<ILendingPool> implements LendingPoolInterface {
