...
import { EthereumTransactionTypeExtended, InterestRate, tEthereumAddress } from '../commons/types';
...
export declare class WETHGatewayService extends BaseService<IWETHGateway> implements WETHGatewayInterface {
    ...
    repayETH({ lendingPool, user, amount, interestRateMode, onBehalfOf, }: WETHRepayParamsType): EthereumTransactionTypeExtended[];
}
