...
import { GeneralStakeUIData, GeneralStakeUIDataHumanized, GetUserStakeUIData, GetUserStakeUIDataHumanized } from './types';
export * from './types';
export interface UiStakeDataProviderInterface {
    getUserStakeUIData: (params: {
        user: string;
...
export declare class UiStakeDataProvider implements UiStakeDataProviderInterface {
    private readonly _contract;
    constructor(context: UiStakeDataProviderContext);
    getUserStakeUIData({ user }: {
        user: string;
    }): Promise<GetUserStakeUIData>;
    getUserStakeUIDataHumanized({ user }: {
        user: string;
    }): Promise<GetUserStakeUIDataHumanized>;
    getGeneralStakeUIData(): Promise<GeneralStakeUIData>;
    getGeneralStakeUIDataHumanized(): Promise<GeneralStakeUIDataHumanized>;
